...
//
//                 Text(
//                     Languages.of(context)!.termcondition,
...
//     await ApiServices.gettermcondition(context, true).then((onValue){
//       if(mounted){
//         setState(() {
    ...
    return MediaQuery(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: MyColor.yellowF6F1E1, // Same color for both
          surfaceTintColor: MyColor.yellowF6F1E1, // Same color for both
          title: Padding(
            padding: const EdgeInsets.only(left: 0),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              ...
              children: [
                TouchRippleEffect(
                  ...
                  child: Icon(
                    Icons.arrow_back_ios,
                    size: isIpad ? 36 : 30, // iPad: larger icon
                    color: Colors.black, // Same color for both
                  ),
                ),
                ...
                Text(
                  ...
                  style: mediumTextStyle(
                      fontSize: isIpad ? 28.0 : 18.0, // iPad: larger font
                      color: MyColor.black // Same color for both
                  ),
                ),
              ],
            ),
        ...
        body: Padding(
          padding: EdgeInsets.symmetric(
            horizontal: isIpad ? 20.0 : 10.0, // iPad: more padding
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  padding: EdgeInsets.all(isIpad ? 10.0 : 0),
                  child: Text(
                    data ?? '',
                    style: regularTextStyle(
                      fontSize: isIpad ? 22.0 : 14.0, // iPad: larger text
                      // Same color for both
                      height: isIpad ? 1.8 : 1.4,
                      color: Colors.black.withOpacity(0.7), // iPad: more line spacing
                    ),
                    textAlign: TextAlign.justify,
                  ),
                ),
                SizedBox(height: isIpad ? 50 : 30), // iPad: more spacing
              ],
            ),
          ),
        ),
