              ...
              Expanded(
                child: SingleChildScrollView(
                  padding: EdgeInsets.only(
                    left: 20,
                    right: 40,
                    bottom: isTablet ? 40 : 0, // iPad ke liye bottom padding add
                  ),
                  child: Column(
                    children: [
                      // Note: `UiUtils.questionAnswerUi` function ke andar font sizes
                      // bhi adjust karna padega agar aap control karna chahte hain
                      UiUtils.questionAnswerUi(AssetsPath.img1,Languages.of(context)!.question1,Languages.of(context)!.answer1,1,isTablet: isTablet),
                      UiUtils.questionAnswerUi(AssetsPath.img2,Languages.of(context)!.question2,Languages.of(context)!.answer2,1,isTablet: isTablet),
                      UiUtils.questionAnswerUi(AssetsPath.img3,Languages.of(context)!.question3,Languages.of(context)!.answer3,3,isTablet: isTablet),
