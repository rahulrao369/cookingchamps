...
class ActivityThreeView extends StatefulWidget {
  const ActivityThreeView({super.key});

  @override
  State<ActivityThreeView> createState() => _ActivityThreeViewState();
}

class _ActivityThreeViewState extends State<ActivityThreeView> {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("${Languages.of(context)!.activity} 1.3",style:mediumTextStyle(fontSize:18.0, color:MyColor.black),)
                    ],
                  ),
  ...
  void setRulesList() {
    rulesList = [
      MatchTheFollowingModel("Always carry knives by the handle pointing down", AssetsPath.knivesImg1,"Always use a chopping board",MyColor.darkOrange),
      MatchTheFollowingModel("If a knife falls DON’T try to catch it", AssetsPath.knivesImg2,"Always carry knives by the handle pointing down",MyColor.darkOrange),
      MatchTheFollowingModel("Always use a chopping board", AssetsPath.knivesImg3,"Always cut away from fingers",MyColor.darkOrange),
      MatchTheFollowingModel("Do not put knives into a sink with soapy water", AssetsPath.knivesImg4,"Always keep finger tips tucked under while cutting or chopping",MyColor.darkOrange),
      MatchTheFollowingModel("Always keep finger tips tucked under while cutting or chopping", AssetsPath.knivesImg5,"If a knife falls DON’T try to catch it",MyColor.darkOrange),
      MatchTheFollowingModel("Always cut away from fingers", AssetsPath.knivesImg6,"Do not put knives into a sink with soapy water",MyColor.darkOrange),
    ];
